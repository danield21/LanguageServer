<?php
	 ...
	 * @version 2.0
	 * @uses Category class - "./Category.php"
	 * This class is meant to allow a quick connection between a mysql and php
	...
	**/
	class CategoriesTable {
		...
		**/
		 ...
		 * @param id - The id of the category being queried for
